...
\subsubsection{Acronyms}
    ...
    \begin{itemize}
        ...
        \item \textbf{OD}: Origin-Destination
    \end{itemize}
...
\subsubsection{Abbreviations}
    ...
    \begin{itemize}
        ...
        \item \textbf{PostGIS}: A spatial database extender for PostgreSQL - Post(greSQL) + GIS
        \item \textbf{GIS}: Geographic Information System
        \item \textbf{JSON}: JavaScript Object Notation
        \item \textbf{GeoJSON}: Geographical extension of JSON format
        \item \textbf{JWT}: JSON Web Token
        \item \textbf{SSL}: Secure Sockets Layer
        \item \textbf{TLS}: Transport Layer Security
        \item \textbf{TTL}: Time To Live
        \item \textbf{API Gateway}: Application Programming Interface Gateway
    \end{itemize}
...
\begin{itemize}
    ...
    \item RASD for BestBikePath 2025/26 Requirement Engineering and Design Project for the Software Engineering II course
\end{itemize}
