...
\hfill%
\begin{minipage}{0.4\textwidth}
Trip summary screen show the user the summary with the ride statistics computations along with the weather enrichment if present. The user has the following 3 options:  \begin{itemize}
    \item Discad the trip.
    \item Save the trip to their profile but not publish the Trip.
    \item Publish the Trip which also saves it to their profile.
\end{itemize}
\end{minipage}
...
\begin{minipage}{0.5\textwidth}
    \includegraphics[width=\linewidth]{Images/UI mockups/Account- list.png}
\end{minipage}
\hfill%
\begin{minipage}{0.4\textwidth}
...
% \includegraphics[scale = 0.5]{Images/UI mockups/Account- list.png}
...
\includegraphics[width=\textwidth]{Images/SequenceDiagram_UC4.png}

\newpage
\textbf{[UC6] Enrich Trip with Weather Data}

\includegraphics[width=\textwidth]{Images/SequenceDiagram_UC6.png}

\newpage
\textbf{[UC7] Manually Insert Bike Path Information}

\includegraphics[width=\textwidth]{Images/SequenceDiagram_UC7.png}

\newpage
\textbf{[UC8] Confirm Automatically Acquired Path Information}

\includegraphics[width=\textwidth]{Images/SequenceDiagram_UC8.png}

\newpage
\textbf{[UC9] Search Bike Paths}

\includegraphics[width=\textwidth]{Images/SequenceDiagram_UC9.png}

\newpage
\textbf{[UC10] Visualize Bike Paths on Map}

\includegraphics[width=\textwidth]{Images/SequenceDiagram_UC10.png}
...
\begin{itemize}
    ...
    \item The system shall use OAuth 2.0 or equivalent for authentication.
\end{itemize}
