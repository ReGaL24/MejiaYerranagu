...
\textbf{G3}: Let registered users automatically record bike path data during rides via GPS-based path reconstruction and sensor-based anomaly detection (e.g., potholes).
